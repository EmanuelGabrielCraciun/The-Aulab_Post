    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <p>&copy; 2024 <a href="#" class="text-white">The Aulab Post</a>. Tutti i diritti riservati.</p>
            </div>
            ...
            <div class="col-md-4 text-md-end">
                <ul class="list-unstyled d-flex justify-content-center justify-content-md-end">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/emanuel-gabriel-craciun-dev" target="_blank" rel="noopener noreferrer">
